<section id="download" class="final-cta">
	<h2><?= e($settings['footer_app_heading'] ?? 'Buy gold anytime, 24/7 with our official mobile app.') ?></h2>
	<p><?= e($settings['footer_app_description'] ?? 'Buy gold of any value, track grams credited to your wallet, view transactions, and request withdrawal securely.') ?>
	</p>
	<div class="actions">
		<?php if (($settings['android_enabled'] ?? '1') === '1'): ?><a class="store"
				href="<?= e(app_download_url($settings, 'android')) ?>"><i class="fa-brands fa-google-play"></i> Play
				Store</a><?php endif; ?>
...
<div class="float-actions">
	...
	<a href="<?= e(app_download_url($settings)) ?>"><i class="fa-solid fa-download"></i></a>
